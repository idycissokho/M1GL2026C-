...
namespace M1GLSERVER.Data
{
    public static class DbSeeder
    {
        public static async Task SeedAsync(DbMemoireContextE2E context, UserManager<Utilisateur> userManager)
        {
            ...
            // Seed Encadreurs avec noms sénégalais
            ...
            // Seed Étudiants avec noms sénégalais
            ...
            var memoires = new List<Memoire>
            {
                new Memoire
                {
                    Titre = "Développement d'une application mobile de gestion des transports urbains à Dakar",
                    Auteur = "Cheikh Ba",
                    Contenu = "Application mobile pour optimiser les transports en commun à Dakar avec géolocalisation et paiement mobile.",
                    Date = DateTime.UtcNow.AddMonths(-6),
                    Statut = "Soutenu",
                    FiliereId = filieres[0].Id,
                    EncadreurId = encadreursDb[0].Id
                },
                new Memoire
                {
                    Titre = "Système de détection de fraudes bancaires par intelligence artificielle",
                    Auteur = "Aminata Diallo",
                    Contenu = "Utilisation du machine learning pour détecter les transactions frauduleuses dans les banques sénégalaises.",
                    Date = DateTime.UtcNow.AddMonths(-4),
                    Statut = "En cours",
                    FiliereId = filieres[3].Id,
                    EncadreurId = encadreursDb[1].Id
                },
                new Memoire
                {
                    Titre = "Plateforme e-learning pour l'enseignement à distance au Sénégal",
                    Auteur = "Ibrahima Gueye",
                    Contenu = "Conception d'une plateforme d'apprentissage en ligne adaptée au contexte sénégalais.",
                    Date = DateTime.UtcNow.AddMonths(-3),
                    Statut = "En cours",
                    FiliereId = filieres[2].Id,
                    EncadreurId = encadreursDb[2].Id
                },
                new Memoire
                {
                    Titre = "Sécurisation des réseaux Wi-Fi publics dans les universités",
                    Auteur = "Khady Thiam",
                    Contenu = "Étude et mise en place de solutions de sécurité pour les réseaux sans fil universitaires.",
                    Date = DateTime.UtcNow.AddMonths(-5),
                    Statut = "Soutenu",
                    FiliereId = filieres[4].Id,
                    EncadreurId = encadreursDb[3].Id
                },
                new Memoire
                {
                    Titre = "Application de gestion agricole pour les producteurs sénégalais",
                    Auteur = "Mamadou Cisse",
                    Contenu = "Solution digitale pour aider les agriculteurs à gérer leurs cultures et prévisions météo.",
                    Date = DateTime.UtcNow.AddMonths(-2),
                    Statut = "En cours",
                    FiliereId = filieres[0].Id,
                    EncadreurId = encadreursDb[4].Id
                },
                new Memoire
                {
                    Titre = "Système de télémédecine pour les zones rurales du Sénégal",
                    Auteur = "Ndeye Mbaye",
                    Contenu = "Plateforme de consultation médicale à distance pour améliorer l'accès aux soins.",
                    Date = DateTime.UtcNow.AddMonths(-7),
                    Statut = "Soutenu",
                    FiliereId = filieres[2].Id,
                    EncadreurId = encadreursDb[5].Id
                },
                new Memoire
                {
                    Titre = "Optimisation des réseaux 5G pour les télécommunications au Sénégal",
                    Auteur = "Abdoulaye Diouf",
                    Contenu = "Étude sur le déploiement et l'optimisation de la 5G dans le contexte sénégalais.",
                ...
                new Memoire
                {
                    Titre = "Chatbot intelligent pour l'administration publique sénégalaise",
                    Auteur = "Sokhna Kane",
                    Contenu = "Assistant virtuel basé sur l'IA pour faciliter les démarches administratives des citoyens.",
                ...
                new Memoire
                {
                    Titre = "Blockchain pour la traçabilité des produits locaux sénégalais",
                    Auteur = "Modou Faye",
                    Contenu = "Utilisation de la blockchain pour garantir l'authenticité des produits Made in Senegal.",
                    Date = DateTime.UtcNow.AddMonths(-3),
                    Statut = "En cours",
                    FiliereId = filieres[0].Id,
                    EncadreurId = encadreursDb[2].Id
                ...
                new Memoire
                {
                    Titre = "Système de surveillance intelligente pour la sécurité urbaine",
                    Auteur = "Awa Seck",
                    Contenu = "Solution de vidéosurveillance avec reconnaissance faciale pour améliorer la sécurité à Dakar.",
                    Date = DateTime.UtcNow.AddMonths(-4),
                    Statut = "En cours",
                    FiliereId = filieres[4].Id,
                    EncadreurId = encadreursDb[3].Id
